...
define('DB_NAME',    'u538714447_gcmfor');
define('DB_USER',    'u538714447_gcmfor123');
...
define('SMTP_PASS',     'PlanoGuerra2026!');  // ← senha do email
...
function setHeaders() {
    // Capture any accidental PHP output (errors/warnings)
